...
const RAW_FEMALE_TEXT_MAP: Record<string, string> = {
  ...
  "عايزك تروح تقعد معاه، وتسأل صح وتفهم المشكلة بشكل كامل.":
    "عايزك تروحي تقعدي معاها، وتسألي صح وتفهمي المشكلة بشكل كامل.",
  ...
  "أهلاً… رجعت. ها، فهمت الصورة ولا لسه؟":
    "أهلاً… رجعتي. ها، فهمتي الصورة ولا لسه؟",
  ...
  "رجعت. ها، وصلت لإيه؟":
    "رجعتي. ها، وصلتي لإيه؟",
  "ده جزء مهم… لكن إيه النتيجة اللي تبنيها على ده؟":
    "ده جزء مهم… لكن إيه النتيجة اللي تبنيها على ده؟",
  ...
  "ها، طمّني. شايف المشكلة كانت فين؟":
    "ها، طمّنيني. شايفة المشكلة كانت فين؟",
  "لا… هنا إنت استعجلت.":
    "لا… هنا إنتي استعجلتي.",
  ...
  "الـ Problem Framing مش رفاهية. ده الفرق بين استشاري حقيقي، وحد بيكتب تقارير وخلاص. أنا هخصملك يومين والتقييم ضعيف.":
    "الـ Problem Framing مش رفاهية. ده الفرق بين استشارية حقيقية، وحد بيكتب تقارير وخلاص. أنا هخصملك يومين والتقييم ضعيف.",
