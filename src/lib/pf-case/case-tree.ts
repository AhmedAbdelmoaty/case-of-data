...
//  - No early leaks (Abu Saeed never mentions years/numbers before player asks)
...
export const NODES: Record<NodeId, CaseNode> = {
  S1: {
    id: "S1",
    context: "البداية: أبو سعيد قاعد قدامك، حاطط إيده على راسه. لسه ما قال أرقام ولا سنين.",
    correct: {
      text: "تعالى نمشي خطوة خطوة يا أبو سعيد. الإحساس ده جالك إزاي بالظبط؟ في رقم معين خلّاك تقف عنده، ولا حاجة في طريقة الشغل اليومي؟",
      abuSaeedReply:
        "والله يا فندم، الموضوع كله إن المحل بيتفتح وبيقفل عادي، الناس داخلة طالعة. بس أنا في آخر الشهر بقعد أبصّ على الورق، وبحس إن الرقم اللي طالع لي مش زي ما أنا متوقّع. مش حاجة أقدر أعدّيها أو أقول عليها صدفة.",
      note: {
        id: "n_s1_problem_open",
        text: "أبو سعيد حاسس إن مبيعات الشهر مش زي ما هو متوقّع — تقييم مبني على إحساس مش رقم.",
      },
    },
    wrong: {
      text: "أبو سعيد، عندي إحساس إن المشكلة دي غالبًا من فريق البيع — يمكن مش بيتحركوا زي الأول. ممكن نبص على شغلهم الأول؟",
      abuSaeedReply:
  ...
  R1: {
    ...
    correct: {
      text: "خد وقتك يا أبو سعيد. قبل ما نحكم على الفريق، احكي لي… إيه أول حاجة شدّت انتباهك وخلّتك تحس إن في حاجة مش ماشية؟",
      abuSaeedReply:
        "تمام يا فندم. بصراحة الموضوع كله إن لما بقعد على الأرقام في آخر الشهر، حاسس إن الرقم النهائي أقل من اللي عامله حسابي. ده اللي شاغلني أكتر من أي حاجة تانية.",
      note: {
        id: "n_r1_recover",
        text: "بعد توجيه السؤال للمشكلة نفسها: قلق أبو سعيد مبني على شعور إن الرقم النهائي أقل من المتوقع.",
      },
    },
    wrong: {
      text: "طب مين تحديدًا من الفريق حاسس إن أداؤه أقل من غيره؟",
      abuSaeedReply:
        "والله… ممكن وليد وهاني. كريم وسامح شغلهم تمام. بس مش متأكد. لو تحب نطلع تقرير لكل واحد فيهم؟",
      note: {
  ...
  S2: {
    id: "S2",
    context: "أبو سعيد قال 'أقل من المتوقع' — محتاج تفهم: متوقّع مقارنةً بإيه؟",
    correct: {
      text: "طب خلينا نقف عند كلمة «مش زي ما متوقع» دي. لما حضرتك بتقارن، بتقارن بإيه؟ بشهر فات؟ بسنة فاتت؟ بميزانية حطّيتها؟ ولا إحساس عام؟",
      abuSaeedReply:
        "اللي بعمله إني باخد رقم الشهر اللي إحنا فيه، فبراير 2026، وأقارنه بنفس الشهر السنة اللي فاتت، يعني فبراير 2025. ولقيت الفرق بالنسبة لي كبير، حاجة تقلق فعلاً، مش حاجة أقدر أسكت عليها.",
      note: {
        id: "n_s2_baseline_one_year",
        text: "أبو سعيد بيقارن فبراير 2026 بفبراير 2025 بس — مرجعية سنة وحدة.",
      },
    },
    wrong: {
      text: "تمام، ممكن أبص على تقرير المبيعات اليومية بتاعت الشهر ده؟ خلينا نشوف الأرقام.",
      abuSaeedReply:
  ...
  S3: {
    ...
    correct: {
      text: "تمام. ممكن أشوف الأرقام دي على ورق؟ التقرير اللي حضرتك بنيت عليه الإحساس ده.",
      abuSaeedReply:
        "أكيد يا فندم. أنا طلبت من المحاسبة تطبعهولي الأسبوع اللي فات لما بدأت أقلق. اتفضل، خد التقرير ده وبصّ بنفسك، أحسن من أي كلام أنا أقوله.",
    ...
    wrong: {
      ...
      abuSaeedReply:
        "ماشي يا فندم، عندي تقرير لكل واحد فيهم. اتفضل، خد ده، فيه الأرقام بتاعتهم كلها.",
  ...
  S4: {
    ...
    correct: {
      text: "حضرتك بتقارن بسنة واحدة بس. ممكن نشوف فبراير 2024 كمان عشان نعرف هل سنة 2025 كانت طبيعية ولا لأ؟",
      abuSaeedReply:
        "والله سؤال في محله. خليني أطلب من المحاسبة تطلّعها لي على ورقة تانية… اتفضل، ده تقرير الـ 3 سنين كلهم جنب بعض. شوف بنفسك، هتفهم أكتر مني.",
  ...
  TRACK_A_1: {
    ...
    wrong: {
      ...
      abuSaeedReply:
        "اتفضل، ده تقرير عملته المحاسبة الأسبوع اللي فات. فيه الفرق في التحويل واضح كمان.",
  ...
  TRACK_A_2: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "اتفضل، ده تقرير التحويلات. هتلاقي إن الفرق فعلاً مش بس في الكميات، الفرق في الإقفال نفسه.",
      evidenceId: "ev_team_conversion",
      note: {
        id: "n_a2",
    ...
    wrong: {
      ...
      note: {
        id: "n_a2_alt",
        text: "أبو سعيد بيعترف إن التدريب والمتابعة اليومية مش منتظمين.",
      },
    },
  ...
  TRACK_A_3: {
    ...
    correct: {
      ...
      note: {
        id: "n_a3",
        text: "اعتراف بضعف التدريب والمتابعة. أبو سعيد لسه عنده شك خفيف.",
      },
    },
    wrong: {
      text: "تمام، يبقى المشكلة محسومة — ضعف تنفيذ من الفريق.",
      abuSaeedReply:
        "ماشي يا فندم… الصورة بقت أوضح. بس بصراحة لسه عندي حاجة جوايا مش مرتاح لها.",
      note: {
        id: "n_a3_alt",
        text: "اللاعب حسم الفرضية بدري، أبو سعيد لسه متردد.",
      },
    },
    nextOnCorrect: "END",
    nextOnWrong: "END",
  ...
  TRACK_B_1: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "اتفضل، ده تقرير المبيعات الأسبوعية. هتلاقي فيه الأسبوع الأخير بالذات الأضعف.",
    ...
    wrong: {
      ...
      abuSaeedReply:
        "آه فعلاً يا فندم. فيه شحنة اتأخرت أسبوع كامل تقريبًا، ومنتجات معينة خلصت من على الرفوف لفترة.",
      note: {
        id: "n_b1_alt",
        text: "أبو سعيد يعترف بتأخير شحنة ونفاد منتجات.",
      },
    },
  ...
  TRACK_B_2: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "أيوه يا فندم. فيه شحنة اتأخرت، وفيه منتجات خلصت من على الرف لفترة. ممكن ده أثّر فعلاً.",
      note: {
        id: "n_b2",
    ...
    wrong: {
      ...
      abuSaeedReply:
        "بصراحة يا فندم مش متابع الساعات بدقة. بس الموظفين بيقولوا فترة بعد العصر بقت أهدى عن قبل كده.",
      note: {
        id: "n_b2_alt",
  ...
  TRACK_B_3: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "كلام معقول يا فندم. الصورة بقت أوضح… بس صدّقني، لسه عندي حاجة جوايا مش مرتاح لها 100%.",
      note: {
        id: "n_b3",
        text: "توصية تشغيلية. أبو سعيد لسه عنده شك خفيف.",
      },
    },
    wrong: {
      text: "نغيّر مواعيد الشغل عشان نوفّر تكلفة الفترات الضعيفة؟",
      abuSaeedReply:
        "هممم… ممكن، بس ده قرار كبير يا فندم. الصورة بقت أوضح، بس لسه في حاجة مش مرتاح لها.",
      note: {
        id: "n_b3_alt",
  ...
  TRACK_C_2: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "بعضهم بيقول غالي شوية يا فندم. بس أنا حاسس إن الجودة بتاعتي أحسن، ومش حابب أنزل.",
      evidenceId: "ev_customer_feedback",
      note: {
        id: "n_c2",
    ...
    wrong: {
      ...
      abuSaeedReply:
        "وارد يا فندم… بس ده قرار محتاج دراسة، مش حاجة آخدها على ضربة.",
      note: {
        id: "n_c2_alt",
  ...
  TRACK_C_3: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "ممكن يا فندم. الصورة بقت أوضح… بس صدقني، لسه عندي حاجة جوايا مش مرتاح لها 100%.",
      note: {
        id: "n_c3",
        text: "توصية بعرض سعري. أبو سعيد متردد.",
      },
    },
    wrong: {
      text: "نعمل خصم 15% على المحل كله شهر كامل؟",
      abuSaeedReply:
        "ده هياكل من الربح يا فندم… الصورة بقت أوضح، بس لسه في حاجة جوايا مش مرتاح لها.",
      note: {
        id: "n_c3_alt",
  ...
  TRACK_D_1: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "اتفضل يا فندم، ده ملخص التسويق اللي عندي. هتلاقي فيه ميزانية الإعلانات والأرقام كلها.",
      evidenceId: "ev_marketing",
      note: {
        id: "n_d1",
    ...
    wrong: {
      ...
      abuSaeedReply:
        "فرق بسيط يا فندم بصراحة. اتفضل ده التقرير، شوف بنفسك مش حاجة كبيرة تبرّر النزول كله.",
      evidenceId: "ev_marketing",
      note: {
        id: "n_d1_alt",
  ...
  TRACK_D_2: {
    ...
    wrong: {
      ...
      abuSaeedReply:
        "ممكن يا فندم… بس مش متأكد ده هيرجّع البيع ولا لأ.",
      note: {
        id: "n_d2_alt",
  ...
  TRACK_D_3: {
    ...
    correct: {
      ...
      note: {
        id: "n_d3",
        text: "توصية حملة تنشيط. شك خفيف من أبو سعيد.",
      },
    },
    wrong: {
      text: "نزوّد ميزانية الإعلانات على طول.",
      abuSaeedReply:
        "هممم… الصورة بقت أوضح يا فندم، بس لسه في حاجة جوايا مش مرتاح لها.",
      note: {
        id: "n_d3_alt",
