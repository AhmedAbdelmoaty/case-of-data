...
export const NODES: Record<NodeId, CaseNode> = {
  S1: {
    ...
    correct: {
      text: "تعالى نمشي خطوة خطوة يا أبو سعيد. الإحساس ده جالك إزاي بالظبط؟ ممكن تحكي لي إيه اللي حاصل وشايف المشكلة فين؟",
      abuSaeedReply:
  ...
  R1: {
    ...
    wrong: {
      ...
      abuSaeedReply: "والله… ممكن وليد وهاني. كريم وسامح شغلهم تمام. بس مش متأكد. لو تحب نطلع تقرير لكل واحد فيهم؟",
      note: {
  ...
  S2: {
    ...
    correct: {
      text: "طب خلينا نقف هنا. لما بتقول المبيعات أقل من المتوقع، حضرتك بتقارن بإيه؟ بشهر فات؟ بسنة فاتت؟ بميزانية حطّيتها؟ ولا ده إحساس عام؟",
      abuSaeedReply:
  ...
  S3: {
    ...
    wrong: {
      ...
      abuSaeedReply: "ماشي يا فندم، عندي تقرير لكل واحد فيهم. اتفضل، خد ده، فيه الأرقام بتاعتهم كلها.",
  ...
  S4: {
    ...
    correct: {
      ...
      abuSaeedReply:
        "مفيش مشكلة. خليني أطلب من المحاسبة تطلّعها لي على ورقة تانية… اتفضل، ده تقرير الـ 3 سنين كلهم جنب بعض. شوف بنفسك.",
    ...
    wrong: {
      ...
      abuSaeedReply: "ماشي يا فندم. أنا جمعت من زمان آخر العروض من المحلات اللي حوالينا. اتفضل، ده اللي عندي.",
  ...
  S5: {
    ...
    wrong: {
      ...
      abuSaeedReply: "اتفضل يا فندم، ده تقرير التسويق بتاع السنة دي والسنة اللي فاتت. هتلاقي فيه الميزانية والأرقام.",
  ...
  TRACK_A_1: {
    ...
    correct: {
      ...
      abuSaeedReply: "أكيد يا فندم. اتفضل، ده الجدول. هتلاقي فرق واضح بين الأول والأخير.",
      evidenceId: "ev_team_performance",
      note: {
        id: "n_a1",
    ...
    wrong: {
      ...
      abuSaeedReply: "اتفضل، ده تقرير عملته المحاسبة الأسبوع اللي فات. فيه الفرق في التحويل واضح كمان.",
  ...
  TRACK_A_2: {
    ...
    correct: {
      ...
      abuSaeedReply: "اتفضل، ده تقرير التحويلات. هتلاقي إن الفرق فعلاً مش بس في الكميات، الفرق في الإقفال نفسه.",
      evidenceId: "ev_team_conversion",
      note: {
        id: "n_a2",
  ...
  TRACK_A_3: {
    ...
    wrong: {
      ...
      abuSaeedReply: "ماشي يا فندم… الصورة بقت أوضح. بس بصراحة لسه عندي حاجة جوايا مش مرتاح لها.",
      note: {
        id: "n_a3_alt",
  ...
  TRACK_B_1: {
    ...
    correct: {
      ...
      abuSaeedReply: "اتفضل، ده تقرير المبيعات الأسبوعية. هتلاقي فيه الأسبوع الأخير بالذات الأضعف.",
    ...
    wrong: {
      ...
      abuSaeedReply: "آه فعلاً يا فندم. فيه شحنة اتأخرت أسبوع كامل تقريبًا، ومنتجات معينة خلصت من على الرفوف لفترة.",
      note: {
        id: "n_b1_alt",
  ...
  TRACK_B_2: {
    ...
    correct: {
      ...
      abuSaeedReply: "أيوه يا فندم. فيه شحنة اتأخرت، وفيه منتجات خلصت من على الرف لفترة. ممكن ده أثّر فعلاً.",
      note: {
        id: "n_b2",
    ...
    wrong: {
      ...
      abuSaeedReply: "بصراحة يا فندم مش متابع الساعات بدقة. بس الموظفين بيقولوا فترة بعد العصر بقت أهدى عن قبل كده.",
      note: {
        id: "n_b2_alt",
  ...
  TRACK_B_3: {
    ...
    correct: {
      ...
      abuSaeedReply: "كلام معقول يا فندم. الصورة بقت أوضح… بس صدّقني، لسه عندي حاجة جوايا مش مرتاح لها 100%.",
      note: {
        id: "n_b3",
    ...
    wrong: {
      ...
      abuSaeedReply: "هممم… ممكن، بس ده قرار كبير يا فندم. الصورة بقت أوضح، بس لسه في حاجة مش مرتاح لها.",
      note: {
        id: "n_b3_alt",
  ...
  TRACK_C_1: {
    ...
    correct: {
      ...
      abuSaeedReply: "اتفضل يا فندم، ده اللي جمعته من حوالينا. أكتر حاجة شايفها خصومات وعروض 2+1 على بعض الموديلات.",
      evidenceId: "ev_competitor_offers",
      note: {
        id: "n_c1",
  ...
  TRACK_C_2: {
    ...
    correct: {
      ...
      abuSaeedReply: "بعضهم بيقول غالي شوية يا فندم. بس أنا حاسس إن الجودة بتاعتي أحسن، ومش حابب أنزل.",
      evidenceId: "ev_customer_feedback",
      note: {
        id: "n_c2",
    ...
    wrong: {
      ...
      abuSaeedReply: "وارد يا فندم… بس ده قرار محتاج دراسة، مش حاجة آخدها على ضربة.",
      note: {
        id: "n_c2_alt",
  ...
  TRACK_C_3: {
    ...
    correct: {
      ...
      abuSaeedReply: "ممكن يا فندم. الصورة بقت أوضح… بس صدقني، لسه عندي حاجة جوايا مش مرتاح لها 100%.",
      note: {
        id: "n_c3",
    ...
    wrong: {
      ...
      abuSaeedReply: "ده هياكل من الربح يا فندم… الصورة بقت أوضح، بس لسه في حاجة جوايا مش مرتاح لها.",
      note: {
        id: "n_c3_alt",
  ...
  TRACK_D_1: {
    ...
    correct: {
      ...
      abuSaeedReply: "اتفضل يا فندم، ده ملخص التسويق اللي عندي. هتلاقي فيه ميزانية الإعلانات والأرقام كلها.",
      evidenceId: "ev_marketing",
      note: {
        id: "n_d1",
    ...
    wrong: {
      ...
      abuSaeedReply: "فرق بسيط يا فندم بصراحة. اتفضل ده التقرير، شوف بنفسك مش حاجة كبيرة تبرّر النزول كله.",
      evidenceId: "ev_marketing",
      note: {
        id: "n_d1_alt",
  ...
  TRACK_D_2: {
    ...
    wrong: {
      ...
      abuSaeedReply: "ممكن يا فندم… بس مش متأكد ده هيرجّع البيع ولا لأ.",
      note: {
        id: "n_d2_alt",
  ...
  TRACK_D_3: {
    ...
    correct: {
      ...
      abuSaeedReply: "كلام منطقي يا فندم. الصورة بقت أوضح… بس صدقني، لسه عندي حاجة جوايا مش مرتاح لها 100%.",
      note: {
        id: "n_d3",
    ...
    wrong: {
      ...
      abuSaeedReply: "هممم… الصورة بقت أوضح يا فندم، بس لسه في حاجة جوايا مش مرتاح لها.",
      note: {
        id: "n_d3_alt",
