...
export const SPINE: Record<SpineNodeId, SpineNode> = {
  S1: {
    ...
    correct: {
      ...
      hishamReply:
        "والله يا فندم، المحل فيه حركة كويسة، والناس داخلة طالعة. بس في آخر الشهر لما قعدت أبصّ على الورق، لقيت المبيعات قليلة، الرقم اللي طالعلي أقل من المتوقّع.",
      note: {
    ...
    wrong: {
      ...
      hishamReply:
        "والله ممكن يا فندم. الفريق عندي من زمان، بس فعلاً ممكن يكونوا اتراخوا في حاجة. خلينا نبص ونشوف.",
      note: {
  ...
  S2: {
    ...
    correct: {
      ...
      hishamReply:
        "أنا قارنت الشهر ده بنفس الشهر السنة اللي فاتت، فبراير 2025. لقيت فبراير السنة دي أقل بحوالي 30%. الرقم ده بالنسبالي كبير، مش حاجة أقدر أسكت عليها.",
      note: {
    ...
    wrong: {
      ...
      hishamReply:
        "اتفضل يا فندم. ده تقرير المبيعات اليومية للشهر ده. هتلاقي أيام الحركة فيها كويسة، وأيام تانية أهدى شوية.",
  ...
  S3: {
    ...
    correct: {
      ...
      hishamReply:
        "أكيد يا فندم. أنا طلبت من المحاسبة تطبعلي التقرير لما بدأت أقلق. اتفضل، خد التقرير ده وبص بنفسك.",
    ...
    wrong: {
      ...
      hishamReply:
        " المنافسة بقت أقوى شوية الفترة دي. المحلات حواليّا بقت بتعمل عروض وخصومات كتير. ده تقرير ملخص عروض المنافسين.. اتفضل شوفه بنفسك.",
  ...
  S4: {
    ...
    correct: {
      ...
      hishamReply:
        "مفيش مشكلة. خليني أطلب تقرير لآخر 3 سنين من المحاسبة… اتفضل ده التقرير. شوف بنفسك.",
  ...
  S5: {
    ...
    correct: {
      ...
      hishamReply:
        "آه طبعًا، عندي تقرير من المحاسبة بيقسّم المبيعات. اتفضل، خد ده وبص بنفسك.",
  ...
  A: {
    ...
    topics: [
      ...
      },
      {
        ...
        hishamReply:
          "اتفضل، ده تقرير فيه نسبة التحويل لكل فرد داخل الفريق. في فروق فعلًا بين البائعين.",
  ...
  C: {
    ...
    topics: [
      ...
      },
      {
        ...
        hishamReply:
          "بعض الزباين فعلاً اشتكوا من أسعار بعض الموديلات، أو سألوا على خصم، بس مش كلهم. اتفضل ده ملف فيه ملاحظات الزباين الفترة الأخيرة.",
