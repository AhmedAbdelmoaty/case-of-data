...
export const EVIDENCE: Record<string, EvidenceData> = {
  ...
  ev_breakdown: {
    ...
    issuer: "الإدارة المالية — VELARO",
    reportDate: "مارس 2026",
    caption: "مبيعات شهر فبراير في السنوات الثلاث الأخيرة مقسمة حسب نوعية المبيعات.",
    footnote:
      "الأرقام بالألف جنيه مصري، صافي مبيعات بعد المرتجعات.\n ملاحظة المحاسبة: في فبراير 2025 جالنا أوردر شركات استثنائي (حوالي 290 ألف) من عميل واحد.",
    rows: [
