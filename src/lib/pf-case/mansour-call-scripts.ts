...
export const MANSOUR_CALL_WEAK: DialogueLine[] = [
  ...
  { characterId: "mansour", text: "هاخصم لك يومين من رصيدك التدريبي، والتقييم في الكيس دي ضعيف. لازم تتعلم: ما تجريش على السبب، وما تجريش على الحل. امسك المرجع الأول.", mood: "disappointed" },
  { characterId: "detective", text: "تمام يا أستاذ منصور. هاتعلّم من الغلطة دي.", mood: "concerned" },
