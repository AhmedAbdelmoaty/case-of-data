...
export const HISHAM_GREETING: DialogueLine[] = [
  ...
  },
  {
    ...
    text: "أهلاً بيك يا أستاذ هشام. أستاذ منصور قال لي إن حضرتك عاوز تتكلم في موضوع شاغلك.",
    mood: "neutral",
  },
  {
    characterId: "hisham",
  ...
  {
    characterId: "detective",
    text: "ما تشغلش بالك. خلينا نهدّى ونفهم سوا. هسألك كام سؤال براحة، وانت قول لي اللي عندك.",
    mood: "confident",
  },
];
...
export const MANSOUR_INTRO_DIALOGUES: DialogueLine[] = [
  ...
  {
    characterId: "mansour",
    text: "بالضبط. ما تجريش على حل، وما تفترضش سبب من بدري. ارجع لي بصورة واضحة: هشام الشريف شايف المشكلة إزاي، والمشكلة الحقيقية فين.",
    mood: "serious",
  },
  {
    characterId: "detective",
